        ...
        <div class="card-body">
            <span>
                <p class="text-justify">
                    <img src="/assets/images/<?= $companySetting->logo ?>" class="d-none d-sm-block" alt="FBA Logo" style="margin-bottom: 20px;">Hello and Welcome to the Smart FBA family! We are happy and grateful that you made the decision to work with us and our dedicated team. We have over 40 team members working hard to make sure your experience is a great one.
                </p>
