        ...
        <div class="sidebar-section">
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                ...
                <li class="nav-item" style="margin-top: 150px;">
                    ...
                    <a href="https://youtu.be/oBlMfTwEGoI" class="nav-link" target="_blank" style="justify-content: center;">
                    ...
                    <div class="effect aeneas" style="padding-top: 0px;">
                        <div class="buttons" style="bottom: 0; margin: 5px 35px 20px">
                            ...
                            <a href="https://youtu.be/oBlMfTwEGoI" target="_blank" class="pinterest" title="Find us on Youtube"><i class="fa fa-youtube-play" aria-hidden="true"></i></a>
