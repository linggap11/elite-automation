        ...
        <div class="sidebar-section">
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                ...
                <li class="nav-item" style="margin-top: 150px;">
                    ...
                    <a href="https://www.youtube.com/watch?v=oBlMfTwEGoI" class="nav-link" target="_blank" style="justify-content: center;">
                    ...
                    <div class="effect aeneas" style="padding-top: 0px;">
                        <div class="buttons" style="bottom: 0; margin: 5px 35px 20px">
                            <a href="https://www.facebook.com/eliteautomationbiz" target="_blank" class="fb" title="Find us on Facebook"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                            <a href="https://www.youtube.com/c/KatieMelissaRyan" target="_blank" class="pinterest" title="Find us on Youtube"><i class="fa fa-youtube-play" aria-hidden="true"></i></a>                            
                            <a href="https://www.linkedin.com/company/68631700/" target="_blank" class="in" title="Find us on Linked In"><i class="fa fa-linkedin" aria-hidden="true"></i></a>
                        </div>
                    </div>
                </li>
